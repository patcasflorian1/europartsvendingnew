...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
  ...
  <head>
    ...
    <link rel="stylesheet" href="cssproductview/style.css" />
    ...
    <script defer src="cssproductview/script.js"></script>
  ...
  <body>
    ...
    <div class="overlay-container">
      <div class="item-overlay">
        <button class="item-overlay__btn">
          <img
            src="data:image/jpg;base64,${model.photoProduct.base64Image1}"
            alt="close image"
        ...
        <div class="item-overlay__mainImg">
          <img
           src="data:image/jpg;base64,${model.photoProduct.base64Image2}"
            alt=""
        ...
        <div class="overlay-img__btns">
          ...
          <button class="overlay-img__btn" data-img="2">
            <img
              src="data:image/jpg;base64,${model.photoProduct.base64Image3}"
              alt="shoe product image"
              class="overlay-img__btn-img"
            />
          </button>
          <button class="overlay-img__btn" data-img="3">
            <img
              src="data:image/jpg;base64,${model.photoProduct.base64Image4}"
              alt="shoe product image"
              class="overlay-img__btn-img"
            />
          </button>
    ...
    <main class="item">
      ...
      <c:forEach var="photo" items="${model.photoAlbum}">
              ...
              <!-- poze -->
                      <img  src="data:image/jpg;base64,${photo}"  alt="next symbol image"
      ...
      <section class="price">
        ...
        <h1 class="price-main__heading">Fall Limited Edition Sneakers</h1>
        <p class="price-txt">
