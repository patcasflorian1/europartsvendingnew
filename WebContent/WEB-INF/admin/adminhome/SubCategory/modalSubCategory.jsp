...
$(document).on("click", ".open-DeleteSubCat", function () {
     var mysubCategoriiId = $(this).data('id');
     $(".modal-body #id").val( mysubCategoriiId);
     var nameSubCategory = $(this).data('id1');
     $(".modal-body #nameSubCategory").val( nameSubCategory);
});
</script>

  <!-- Modal Delete SubCategory -->
  <div class="modal fade" id="DeleteSubCat" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
        <form:form action="delete-subcategory.htm" metod="post" commandName="deleteSubCategory">
        <input type="text" name="id" id="id" value=""/>
        <h3>CategoryName</h3>
        <br>
         <input type="text" name="nameSubCategory" id="nameSubCategory" value=""/>
